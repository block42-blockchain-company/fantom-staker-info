function addValidator(validator) {
  ...
  <div class="cell name" data-title="Name">
    ...
    <div class="float-lg-left ml-lg-3 mt-sm-2 mt-lg-0">
      ...
      <p class="text-lg-left font-weight-light text-truncate address"><a href="https://vision.fantom.rocks/#/validator/${validator.address}">${validator.address.toLowerCase()}</a></p>
    </div>
  </div>
